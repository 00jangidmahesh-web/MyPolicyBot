"""Build the LangGraph workflow and expose ask() function."""

from langgraph.graph import StateGraph, END
from langchain_core.messages import HumanMessage, AIMessage
from core.state import AgentState
from core.nodes import (
    intent_classifier, route_after_classify, greet,
    retrieve, out_of_scope_handler
)
from retrieval.generate import run_llm   # ✅ FIXED: 'rag' -> 'retrieval'
