"""Test questions for RAG evaluation – categorized as ANSWERABLE, PARTIALLY_ANSWERABLE, UNANSWERABLE."""

EVAL_QUESTIONS = [
    # --- ANSWERABLE (fully present in docs) ---
    {
        "id": 1,
    ...
    # --- PARTIALLY ANSWERABLE (only part of question is answerable) ---
    {
        "id": 2,
    ...
    # --- UNANSWERABLE (not in any policy doc) ---
    {
        "id": 4,
